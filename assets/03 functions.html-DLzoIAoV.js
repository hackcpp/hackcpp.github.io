...
int `),A,o(` () {
  ...
  return 0;
}`)])]),_:1})]),_:1})]),_:1}),k,n(t.TopToggleContent,{title:"返回值(Return Types)"},{toggle:l(()=>[n(t.ToggleContent,{title:"有返回值"},{toggle:l(()=>[n(t.CodeBox,null,{code:l(()=>[e("pre",null,[n(t.ColorSpan,{data:"double",color:"red"}),o(),L,o(` (double x) {
...
}`)])]),_:1})]),display:l(()=>[e("li",null,[n(t.ColorSpan,{data:"return"}),o(" int, double, …")])]),_:1}),w,n(t.ToggleContent,{title:"无返回值"},{toggle:l(()=>[n(t.CodeBox,null,{code:l(()=>[e("pre",null,[n(t.ColorSpan,{data:"void",color:"red"}),o(),N,o(` (int n) {
  for (int i = 1; i <= n; ++i)
    cout << square(i) << '\\n';
...
❗ `),Q])]),_:1})]),_:1})]),_:1})])}const no=u(C,[["render",U],["__file","03 functions.html.vue"]]),eo=JSON.parse('{"path":"/coding/cpp/03%20functions.html","title":"c++ 教程：函数的使用","lang":"zh-CN","frontmatter":{"title":"c++ 教程：函数的使用","order":2,"category":["cpp教程"],"tag":["c++"],"description":"c++ 中函数的使用教程，函数定义、返回值等","sticky":707,"head":[["meta",{"name":"keywords","content":"c++ function"}],["meta",{"property":"og:url","content":"https://hackcpp.github.io/coding/cpp/03%20functions.html"}],["meta",{"property":"og:site_name","content":"程序员的白粥馆"}],["meta",{"property":"og:title","content":"c++ 教程：函数的使用"}],["meta",{"property":"og:description","content":"c++ 中函数的使用教程，函数定义、返回值等"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-10-02T08:43:07.000Z"}],["meta",{"property":"article:author","content":"Mr.Hackcpp"}],["meta",{"property":"article:tag","content":"c++"}],["meta",{"property":"article:modified_time","content":"2024-10-02T08:43:07.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"c++ 教程：函数的使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-10-02T08:43:07.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Mr.Hackcpp\\",\\"url\\":\\"/portfolio.html\\"}]}"]]},"headers":[],"git":{"createdTime":1727839516000,"updatedTime":1727858587000,"contributors":[{"name":"hackcpp","email":"liuheng2015@gmail.com","commits":3}]},"readingTime":{"minutes":2.65,"words":795},"filePathRelative":"coding/cpp/03 functions.md","localizedDate":"2024年10月2日","excerpt":""}');export{no as comp,eo as data};
